...
CREATE INDEX TB_RESPOSTA_QUESTAO_FKIndex1 ON TB_RESPOSTA_QUESTAO (Id_Questao);
GO
CREATE INDEX TB_RESPOSTA_QUESTAO_FKIndex2 ON TB_RESPOSTA_QUESTAO (Id_Resposta);
GO


CREATE INDEX IFK_Rel_49 ON TB_RESPOSTA_QUESTAO (Id_Questao);
GO
CREATE INDEX IFK_Rel_50 ON TB_RESPOSTA_QUESTAO (Id_Resposta);
GO
...
CREATE TABLE Tb_PERFIL_RESPOSTA_QUESTAO (
  Id_Perfil INTEGER  NOT NULL  ,
  Id_Questao INTEGER  NOT NULL  ,
  Id_Resposta INTEGER  NOT NULL    ,
PRIMARY KEY(Id_Perfil, Id_Questao,Id_Resposta)  ,
  ...
  FOREIGN KEY(Id_Questao, Id_Resposta)
    REFERENCES TB_RESPOSTA_QUESTAO(Id_Questao, Id_Resposta));
GO


CREATE INDEX Table_18_FKIndex1 ON Tb_PERFIL_RESPOSTA_QUESTAO (Id_Perfil);
GO


CREATE INDEX IFK_Rel_27 ON Tb_PERFIL_RESPOSTA_QUESTAO (Id_Perfil);
GO
CREATE INDEX IFK_Rel_34 ON Tb_PERFIL_RESPOSTA_QUESTAO (Id_Questao, Id_Resposta);
GO
...
CREATE TABLE TB_RESPOSTA_QUESTAO_has_TB_CURSO (
  Id_Curso INTEGER  NOT NULL  ,
  Id_Questao INTEGER  NOT NULL  ,
  Id_Resposta INTEGER  NOT NULL    ,
...
CREATE INDEX TB_RESPOSTA_QUESTAO_has_TB_CURSO_FKIndex2 ON TB_RESPOSTA_QUESTAO_has_TB_CURSO (Id_Curso);
GO


CREATE INDEX IFK_Rel_47 ON TB_RESPOSTA_QUESTAO_has_TB_CURSO (Id_Questao, Id_Resposta);
GO
CREATE INDEX IFK_Rel_48 ON TB_RESPOSTA_QUESTAO_has_TB_CURSO (Id_Curso);
GO
